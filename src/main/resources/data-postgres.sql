...
-- Insert this data AFTER running schema-postgres.sql
...
-- Insert Vehicles
INSERT INTO vehicles (registration_number, type, max_weight_kg, max_volume_m3, available) VALUES
('VAN-001', 'VAN', 800.0, 10.0, true),
('VAN-002', 'VAN', 800.0, 10.0, true),
('TRUCK-001', 'TRUCK', 3500.0, 40.0, true),
('BIKE-001', 'BIKE', 15.0, 0.5, true);

-- Insert Deliveries (Paris area)
INSERT INTO deliveries (address, latitude, longitude, weight_kg, volume_m3, preferred_time_slot, status, tour_id, sequence_in_tour) VALUES
